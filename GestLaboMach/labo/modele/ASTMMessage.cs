...
namespace ASTMMessage
{
    public class Message
    {
        ...
        const char caret = '^';
        string delimiterDef = @"|\^&";
        string instrument = @"H500^001YOXH00031^1.0.0.6";
        string host = "host";
        ...
        public string[] SendOrder()
        {
            ...
            send[0] = enq;
            send[1] = Header();
            send[2] = Patient(_barcode, "zakaria", "jahoui", 30, 'M');
        ...
        public string Header()
        {
            ...
            record = "1" + recordType + delimiterDef + new String(pipe, 3) + instrument + new String(pipe, 5) + host + new String(pipe, 2) + "P|LIS2-A2" + pipe + "1";
        ...
        public string Patient(int barcode, string name, string name2, int age, char sex)
        {
            string record;
            recordType = 'P';

            record = "2" + recordType + pipe + "1" + new String(pipe, 2) + barcode.ToString() + new String(pipe, 2) + name + "^" + name2 + new String(pipe, 3) + sex + new String(pipe, 5);
            record = record + cr + etx;
            record = stx + record;
            return record;
        }
