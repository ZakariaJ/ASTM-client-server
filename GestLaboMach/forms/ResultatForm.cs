...
namespace GestLaboMach.forms
{
    public partial class ResultatForm : Form
    {
        ...
        private void btn_envoyerMsg_Click(object sender, EventArgs e)
        {
            this.tcpipCliObj.envoyerMsgAuServeur(this.txt_infos.Text.Trim());
        }

        private void ResultatForm_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.tcpipCliObj.seDeconnecter();
        }
    }
}
=======
